...
impl Attempt {
    pub fn new<S: Into<String>>(code:Option<u32>, message:S, execution_state:ExecutionState) -> Self {
        Attempt {
            code: code,
...
impl WebhookResult {
    pub fn new(events_received:u32, fail_count:u32, success_count:u32, results:Vec<WebhookAttemptResult>) -> Self {
        WebhookResult {
...
impl Webhook {
    ...
    pub fn connect_webhook<F,G>(&mut self, updates_channel: Receiver<ExecutionState>, emitter_func:F, backoff_retry_period:G) -> JoinHandle<WebhookResult>   
